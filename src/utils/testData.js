...
export const testCharacters = [
	{
		...
		currentAttack: { name: 'Flag Pole', attribute: 'Finesse', skill: 'Melee', speedCost: 3, damDiceBonus: 0, damSuccBonus: 3, atkDiceBonus: 0, atkSuccBonus: 0 },
		status: { 
		...
		currentAttack: { name: 'Throw Stone', attribute: 'Perception', skill: 'Firearms', speedCost: 3, damDiceBonus: 2, damSuccBonus: 1, atkDiceBonus: 0, atkSuccBonus: 0 },
		status: { 
			health: { upper: [3,4], lower: [4,4], main: [1,4], off: [3,4], legs: [4,4] },
		},
